...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'header' => 'GESTIÓN DE DATOS GENERALES',
        ...
        [
            ...
            'route' => 'admin.tipo_producto.index',
            'icon' => 'fas fa-fw fa-tags',
            'active' => ['admin/tipo_producto*'],
            'can' => 'admin.tipo_producto.index'
        ],
        [
            'text' => 'Producto',
        ...
        [
            ...
            'icon' => 'fas fa-solid fa-fw fa-briefcase',
        ...
        [
            ...
            'route' => 'admin.tipo_servicio.index',
            'icon' => 'fas fa-tools',
            'active' => ['admin/tipo_servicio*'],
            'can' => 'admin.tipo_servicio.index'
        ],
        [
            'text' => 'Servicio',
