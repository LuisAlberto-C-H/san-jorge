...
<div class="mb-4" style="padding-left:30px; padding-right:30px; ">
    <div style="background-color: #ffffff; color:#434443; padding-left:15px; border-radius:3px; font-size:17px; padding-top:5px; padding-bottom:5px;"><i class="fas fa-solid fa-briefcase"></i> / Agregar cliente</div>
</div>
...
<div class="" style="padding-left:30px; padding-right:30px; ">
    <div class="card-body" style="background-color: #FFFFFF; padding-left:60px; padding-right:60px;">
        ...
        <form id="formCliente" action="{{ route('admin.cliente.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-4">
                    <div class="form-group position-relative">
                        ...
                        <div class="input-group">
                            ...
                            <input id="persona" name="persona" class="form-control @error('persona_id') is-invalid @enderror borde-input" type="text" placeholder="Buscar Persona..." autocomplete="off">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('razon_social') is-invalid @enderror focus-input borde-input" type="text" name="razon_social" value="{{ old('razon_social') }}" placeholder="Ingrese razón social..." autocomplete="off">

                        <span style="font-size:0.88em; color: #97450f;">Razón social/ caso de no tener dejar vacio...</span>
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('nit') is-invalid @enderror focus-input borde-input" type="text" name="nit" value="{{ old('nit') }}" placeholder="Ingrese NIT..." autocomplete="off">

                        <span style="font-size:0.88em; color: #97450f;">NIT/ caso de no tener ingresar CI...</span>
                        @error('nit')
                                <p class="invalid-feedback" style="color: red; font-size: 0.8em;">{{ $message }}</p>
                        @enderror
                    </div>
