...
<div class="mb-4" style="padding-left:30px; padding-right:30px; ">
    <div style="background-color: #ffffff; color:#434443; padding-left:15px; border-radius:3px; font-size:17px; padding-top:5px; padding-bottom:5px;"><i class="fas fa-cube"></i> / Agregar producto</div>
</div>
...
<div class="" style="padding-left:30px; padding-right:30px; ">
    <div class="card-body" style="background-color: #FFFFFF; padding-left:70px; padding-right:70px;">
        ...
        <form class="mt-2" id="formProductos" action="{{ route('admin.producto.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <select class="form-control tipo_productoSelect2" name="tipo_producto_id" id="tipo_producto_id" style="width: 100%;">
                        ...
                        @foreach ($tipo_productos as $tipo_producto)
                            <option value="{{ $tipo_producto->id }}" {{ old('tipo_producto_id') == $tipo_producto->id ? 'selected' : '' }}>{{ $tipo_producto->nombre }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('nombre') is-invalid @enderror focus-input mi-input capitalizar-primera-letra" type="text" name="nombre" value="{{ old('nombre') }}" placeholder="ingrese nombre del producto..." autocomplete="off">
                        @error('nombre')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('descripcion') is-invalid @enderror focus-input mi-input capitalizar-primera-letra" name="descripcion" placeholder="Ingrese descripción del producto..." autocomplete="off">{{ old('descripcion') }}</textarea>
                        @error('descripcion')
                            <p class="invalid-feedback" style="color: red; font-size: 0.8em;">{{ $message }}</p>
                        @enderror
                    </div>
