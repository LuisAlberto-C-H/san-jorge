...
<div class="mb-4" style="padding-left:30px; padding-right:30px; ">
    <div style="background-color: #ffffff; color:#434443; padding-left:15px; border-radius:3px; font-size:17px; padding-top:5px; padding-bottom:5px;"><i class="fas fa-user-tie"></i> / Agregar proveedor</div>
</div>
...
<div class="" style="padding-left:30px; padding-right:30px; ">
    <div class="card-body" style="background-color: #FFFFFF; padding-left:60px; padding-right:60px;">
        ...
        <form id="formProveedor" action="{{ route('admin.proveedor.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('razon_social') is-invalid @enderror focus-input borde-input capitalizar-primera-letra" type="text" name="razon_social" value="{{ old('razon_social') }}" placeholder="ingrese razón social..." autocomplete="off">
                        @error('razon_social')
                                <p class="invalid-feedback" style="color: red; font-size: 0.8em;">{{ $message }}</p>
                        @enderror
                    </div>
...
@section('css')
    ...
    <style>
        ...
        .focus-input:focus {
            ...
            background-color: #ffffff; /* Cambia fondo al blanco en foco */
        }
