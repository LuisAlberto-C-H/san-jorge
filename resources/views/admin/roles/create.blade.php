...
<div class="mb-4" style="padding-left:30px; padding-right:30px; ">
    <div style="background-color: #ffffff; color:#434443; padding-left:15px; border-radius:3px; font-size:17px; padding-top:5px; padding-bottom:5px;"><i class="fas fa-user-cog"></i> / Agregar rol</div>
</div>
        ...
        <form action="{{ route('admin.roles.store') }}" method="POST">
            ...
            <div class="text-center"">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control borde-input focus-input capitalizar-primera-letra" placeholder="Ingrese nombre del nuevo rol...">
                    @error('name')
                        ...
                        <div class="col-md-4 mb-2">
                            @foreach ($columnaPermisos as $permiso)
                                <div class="custom-control custom-checkbox" style="padding-bottom: .45rem;">
                                    ...
                                    @if(isset($permisosAsignados) && in_array($permiso['id'], $permisosAsignados)) checked @endif>
