...
<div class="mb-4" style="padding-left:30px; padding-right:30px; ">
    <div style="background-color: #ffffff; color:#434443; padding-left:15px; border-radius:3px; font-size:17px; padding-top:5px; padding-bottom:5px;"><i class="fas fa-wrench"></i>/ Editar servicio</div>
</div>
...
<div class="" style="padding-left:30px; padding-right:30px; ">
    <div class="card-body" style="background-color: #FFFFFF; padding-left:50px; padding-right:50px;">
        ...
        <form id="formServicios" action="{{ route('admin.servicio.update', $servicio->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    <select class="form-control tipo_servicioSelect2" name="tipo_servicio_id" id="tipo_servicio_id" style="width: 100%;">
                        ...
                        @foreach ($tipo_servicios as $tipo_servicio)
                            <option value="{{ $tipo_servicio->id }}" {{ $servicio->tipo_servicio_id == $tipo_servicio->id ? 'selected' : '' }}>{{ $tipo_servicio->nombre }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('nombre') is-invalid @enderror focus-input mi-input capitalizar-primera-letra" type="text" name="nombre" value="{{ old('nombre', $servicio->nombre) }}" placeholder="ingrese nombre del servicio..." autocomplete="off">
                        @error('nombre')
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control @error('precio') is-invalid @enderror focus-input mi-input" type="number" step="0.01" min="0" name="precio" value="{{ old('precio',$servicio->precio) }}" placeholder="Ingrese descripción del servicio..." autocomplete="off">
                        </div>
                        @error('precio')
                                <p class="invalid-feedback" style="color: red; font-size: 0.8em;">{{ $message }}</p>
                        @enderror
