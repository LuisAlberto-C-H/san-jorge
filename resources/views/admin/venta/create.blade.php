...
<div class="mb-4" style="padding-left:30px; padding-right:30px; ">
    <div style="background-color: #ffffff; color:#434443; padding-left:15px; border-radius:3px; font-size:17px; padding-top:5px; padding-bottom:5px;"><i class="fas fa-receipt"></i> / Agregar Venta</div>
</div>
...
<div class="" style="padding-left:30px; padding-right:30px; ">
    <div class="card-body" style="background-color: #FFFFFF; padding-left:70px; padding-right:70px;">
        ...
        <form id="formVenta" action="{{ route('admin.venta.store') }}" method="POST">
                ...
                <div class="col-5">
                    <div class="form-group position-relative">
                        ...
                        <div class="input-group">
                            ...
                            <input id="cliente" name="cliente" class="form-control @error('cliente_id') is-invalid @enderror borde-input" type="text" placeholder="Buscar Cliente..." autocomplete="off" style="height: 35px !important;">
                            
                            <input type="hidden" name="cliente_id" id="cliente_id">
                        </div>
                
                        <div id="cliente-lista" class="list-group position-absolute w-100" style="z-index: 100;"></div>
                ...
                <div class="col-5 ml-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control @error('monto_total') is-invalid @enderror focus-input borde-input" type="number" step="0.01" min="0" name="monto_total" value="{{ old('monto_total') }}" placeholder="Ingrese monto total de la venta..." autocomplete="off" style="height: 35px !important;">
                        </div>
                        @error('monto_total')
                                <p class="invalid-feedback" style="color: red; font-size: 0.8em;">{{ $message }}</p>
                        @enderror
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('click', '.cliente-item', function() {
                    ...
                    $('#cliente').val(nombre); // Poner el nombre del cliente seleccionado en el input
                    $('#cliente_id').val(clienteId); // Guardar el ID en el campo oculto
                    $('#cliente-lista').slideUp(); // Cerrar la lista de sugerencias con animación
                });
            });
        </script>
